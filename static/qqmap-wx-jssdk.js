...
class QQMapWX {
  ...
  getSuggestion (options) {
    ...
    // 排序
    if (options.location) {
      var locationsuccess1 = function (result) {
      ...
      Utils.locationProcess(options, locationsuccess1)
    } else {
      if (options.sig) {
        requestParam.sig = Utils.getSig(requestParam, options.sig, 'suggest')
      }
  ...
  reverseGeocoder (options) {
    ...
    var locationsuccess2 = function (result) {
      requestParam.location = result.latitude + ',' + result.longitude
      if (options.sig) {
    ...
    Utils.locationProcess(options, locationsuccess2)
  }
  ...
  calculateDistance (options) {
    ...
    if (requestParam.mode === 'straight') {
      var locationsuccess3 = function (result) {
      ...
      Utils.locationProcess(options, locationsuccess3)
    } else {
      var locationsuccess4 = function (result) {
      ...
      Utils.locationProcess(options, locationsuccess4)
    }
  }
  ...
  direction (options) {
    ...
    var locationsuccess5 = function (result) {
      requestParam.from = result.latitude + ',' + result.longitude
      if (options.sig) {
        requestParam.sig = Utils.getSig(
          requestParam,
    ...
    Utils.locationProcess(options, locationsuccess5)
  }
}
